...
from LIVE.Trilateration import calc_dist
...
# snom HQ
offset6OG = (0 * x_ratio, 409 * y_ratio)
offset7OG = (0 * x_ratio, 0 * y_ratio)
# Feuerstrecke
#offset6OG = (400 * x_ratio, 0 * y_ratio)
#offset7OG = (0 * x_ratio, 0 * y_ratio))
# Kubus Abmessungen: 

m9bpositions = [
    {'m9b_IPEI': '0328D7830E','x': 60.0 * x_ratio, 'y':60.0 * y_ratio, 'z':0.0},
    {'m9b_IPEI': '0328D3C918','x': 60.0 * x_ratio, 'y':140.0 * y_ratio, 'z':0.0},
    {'m9b_IPEI': '0328D3C922','x': (60.0+5*18) * x_ratio, 'y':140.0 * y_ratio, 'z':0.0},

# snom HQ
    {'m9b_IPEI': '0328D78483','x': 1012.0 * x_ratio, 'y':174.0 * y_ratio, 'z':280.0}, # Eingang7OG
    {'m9b_IPEI': '0328D784B4','x': 923.0 * x_ratio, 'y': 77.0 * y_ratio, 'z':280.0}, # MeetingW7OG
    {'m9b_IPEI': '0328D783CA','x': 528.0 * x_ratio, 'y':337.0 * y_ratio, 'z':280.0}, # Sales
    {'m9b_IPEI': '0328D78493','x': 230.0 * x_ratio, 'y': 98.0 * y_ratio, 'z':280.0}, # Küche
    {'m9b_IPEI': '0328D78491','x': 736.0 * x_ratio, 'y':259.0 * y_ratio, 'z':280.0}, # Meeting G
    {'m9b_IPEI': '0328D783C1','x': 405.0 * x_ratio, 'y': 35.0 * y_ratio, 'z':280.0}, # Marketing
    {'m9b_IPEI': '0328D7848F','x': 566.0 * x_ratio, 'y':238.0 * y_ratio, 'z':280.0}, # Treppe7OG
    {'m9b_IPEI': '0328D78488','x': 213.0 * x_ratio, 'y':417.0 * y_ratio, 'z':0.0}, # Poststelle
    {'m9b_IPEI': '0328D783CB','x': 567.0 * x_ratio, 'y':586.0 * y_ratio, 'z':0.0}, # Treppe6OG
    {'m9b_IPEI': '0328D3C8FC','x': 130.0 * x_ratio, 'y':515.0 * y_ratio, 'z':0.0}, # RMA6OG
    {'m9b_IPEI': '0328D78490','x': 185.0 * x_ratio, 'y':590.0 * y_ratio, 'z':0.0}, # Küche6OG
    {'m9b_IPEI': '0328D78492','x': 907.0 * x_ratio, 'y':591.0 * y_ratio, 'z':0.0},  # StandUp6OG
    {'m9b_IPEI': '0328D783C6','x': 190.0 * x_ratio, 'y':741.0 * y_ratio, 'z':0.0}, # Interop6OG
    {'m9b_IPEI': '0328D7848C','x': 837.0 * x_ratio, 'y':509.0 * y_ratio, 'z':0.0}, # Meeting6OG
    {'m9b_IPEI': '0328DD5F00','x': 850.0 * x_ratio, 'y':471.0 * y_ratio, 'z':0.0} # Meeting6OGTisch
...
if __name__ == "__main__":
    ...
    background_surfacet = pygame.image.load("./Raumplan_snom_white.png")
