...
class DECT_KNX_gateway_connector:
    ...
    def fire_KNX_action(self, device_bt_mac, gateway, trigger):
        ...
        try:
            ...
            print('pool full, action discarded')
            gevent.sleep(0)

        print("Pool free:",self.pool.free_count())
    ...
    def worker(self):
        ...
        while True:
            ...
            try:
                ...
                print(f'task {wt} finished, pool_free={self.pool.free_count()}')
    ...
    def _fire_KNX_action(self, device_bt_mac, gateway, trigger):
        ...
        print(f'match in list of actionURLS: {matched_bt_mac}')

        if not matched_bt_mac:
            print(f'No match in list of actionURLS for { device_bt_mac}, {gateway}, {trigger}')
            return False
...
if __name__ == "__main__":
    KNX_gateway = DECT_KNX_gateway_connector(knx_url='http://10.110.16.66:1234', maxsize=5)
